...
这是一个 program 程序项目合集，汇总了适合C/C++程序员练手和提升技能的各类项目，涵盖从初级到高级的多个层次。每个项目都附有简要描述，帮助你选择适合自己当前水平和兴趣的练习内容。通过完成这些项目，你将逐步掌握C/C++编程的核心概念和实战技巧，为未来的职业发展打下坚实基础。
...
cppreference 网址: https://en.cppreference.com

cpp开发用户指南: https://github.com/isocpp/CppCoreGuidelines

isocpp 网址: https://isocpp.org

google 编码规范: https://github.com/google/styleguide

ai 项目代码分析: https://github.com/AsyncFuncAI/deepwiki-open
